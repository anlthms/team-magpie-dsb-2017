...
def get_model(input_shape=(preprocess.SEG_CROP,preprocess.SEG_CROP,preprocess.SEG_CROP,1)):
    ...
    model.compile(optimizer=Adam(lr=0.002),loss=resnet3.dice_coef_loss,loss_weights=[0.2,0.3,0.5])
    print model.summary()
    return model
